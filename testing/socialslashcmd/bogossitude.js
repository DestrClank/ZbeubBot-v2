...
module.exports = {
	"bogossituderandom": function(message) {
		...
		const embedMessageRNG = new Discord.MessageEmbed()
			...
			.setDescription(`Quel bogossitude **${user.username}#${user.discriminator}** OnO !`)
			.setImage('https://cdn.discordapp.com/attachments/830828771173990420/922831617041498192/Sans_titre_95_20211220110906.png');
		return message.reply({ embeds: [embedMessageRNG] })
	}, 
	"bogossitudemember": function(message, arg) {
		const embedMessageRNG = new Discord.MessageEmbed()
			.setColor(values.settings.embedColor)
			.setDescription(`Quel bogossitude **${arg.username}#${arg.discriminator}** OnO !`)
			.setImage('https://cdn.discordapp.com/attachments/830828771173990420/922831617041498192/Sans_titre_95_20211220110906.png');
		return message.reply({ embeds: [embedMessageRNG] })
	}
}
