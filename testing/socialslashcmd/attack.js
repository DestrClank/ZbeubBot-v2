...
module.exports = {
	...
	"attackmember": function(message, arg) {
		const embedMessageRNG = new Discord.MessageEmbed()
			.setColor(values.settings.embedColor)
			.setDescription(`Pikachu fait Boule Elek à **${arg.username}#${arg.discriminator}** ! C'est très efficace !`)
			.setImage("https://cdn.discordapp.com/attachments/872866306473472040/872866875791523930/pika_attack.gif");
		return message.reply({ embeds: [embedMessageRNG] })
	}
}
