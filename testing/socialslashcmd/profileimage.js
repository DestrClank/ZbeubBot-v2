...
module.exports = async (message, arg, client) => {

    //console.log(arg)

    infomember = await message.guild.members.cache.get(arg.id)

    timestampmember = infomember.joinedTimestamp;
    username = infomember.displayName;
    servername = message.guild.name;
    useravatar = arg.displayAvatarURL({ format: 'jpg' });
